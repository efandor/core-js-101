...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  const vectorMod1 = x1 ** 2 + y1 ** 2;
  const vectorMod2 = x2 ** 2 + y2 ** 2;
  return Math.acos(dotProd / (Math.sqrt(vectorMod1) * Math.sqrt(vectorMod2)));
}
 ...
 *   1678, 2  => 1700
 *   1678, 3  => 2000
 *   return (pow !== 0) ? (num - (num % (10 ** pow)) + (10 ** pow)) : num;
 */
